...
MARKERS = ['abbreviated', 'summarized as follows', 'ballot label', 'Ballot Question', 'BALLOT QUESTION', 'measure summarized']
...
json.dump(result, open('/private/tmp/claude-501/-Users-ciarazavala-Desktop-Ballot-Preview-Backfill/28cd04c7-f986-44cf-90af-3f056f743036/scratchpad/smc_page_locations.json', 'w'), indent=2)
